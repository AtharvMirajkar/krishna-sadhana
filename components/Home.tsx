      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20">
          <div className="text-center space-y-8 animate-fadeIn">
            ...
            <p className="text-2xl md:text-3xl text-gray-700 dark:text-gray-300 font-medium animate-slideUp" style={{ animationDelay: '0.1s' }}>
              Welcome to Your Spiritual Journey
            </p>

            <p className="text-lg md:text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto animate-slideUp" style={{ animationDelay: '0.2s' }}>
              Immerse yourself in divine chanting, track your spiritual progress, and deepen your devotion to Lord Krishna
            </p>

            <div className="flex flex-wrap justify-center gap-4 pt-8 animate-slideUp" style={{ animationDelay: '0.3s' }}>
              <button
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-24 animate-fadeIn" style={{ animationDelay: '0.4s' }}>
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300">
              ...
              <h3 className="text-2xl font-bold text-gray-800 dark:text-white mb-4">Mantra Library</h3>
              <p className="text-gray-600 dark:text-gray-300">
                Access a beautiful collection of sacred Krishna mantras with audio playback and detailed meanings
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300">
              ...
              <h3 className="text-2xl font-bold text-gray-800 dark:text-white mb-4">Track Progress</h3>
              <p className="text-gray-600 dark:text-gray-300">
                Monitor your daily, weekly, and monthly chanting with beautiful visualizations and insights
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300">
              ...
              <h3 className="text-2xl font-bold text-gray-800 dark:text-white mb-4">Deepen Devotion</h3>
              <p className="text-gray-600 dark:text-gray-300">
                Cultivate a consistent spiritual practice and strengthen your connection with Lord Krishna
              </p>
            </div>
          </div>
